define(["require", "exports", "knockout", "../validation/fieldValidators/DagnummerFieldValidator", "../validation/fieldValidators/AangiftenummerFieldValidator"], function (require, exports, ko, DagnummerFieldValidator, AangiftenummerFieldValidator) {
    "use strict";
    var AangifteDataModelMapper = (function () {
        function AangifteDataModelMapper() {
        }
        AangifteDataModelMapper.prototype.dataModelToViewModel = function (model) {
            var viewModel = {
        ...
        AangifteDataModelMapper.prototype.viewModelToDataModel = function (viewModel) {
            var model = {
                id: viewModel.id(),
                name: viewModel.name(),
        ...
        AangifteDataModelMapper.prototype.addErrorHandling = function (detailModel) {
        ...
        return AangifteDataModelMapper;
    }());
    return AangifteDataModelMapper;
});
