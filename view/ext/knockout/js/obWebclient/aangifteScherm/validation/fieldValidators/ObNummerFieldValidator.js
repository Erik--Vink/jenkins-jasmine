...
define(["require", "exports", "../../../shared/validation/fieldValidators/NumericFieldValidator"], function (require, exports, NumericFieldValidator) {
    "use strict";
    var ObNummerFieldValidator = /** @class */ (function (_super) {
        __extends(ObNummerFieldValidator, _super);
        function ObNummerFieldValidator() {
            var _this = _super.call(this) || this;
            _this.fieldName = "obNummer";
            return _this;
        }
        ObNummerFieldValidator.prototype.mask = function (unmaskedInputValue) {
        ...
        ObNummerFieldValidator.prototype.unmask = function (maskedValue) {
            if (maskedValue) {
        ...
        ObNummerFieldValidator.prototype.getValidationResult = function (fieldValue) {
        ...
        ObNummerFieldValidator.prototype.isValidElevenProof = function (inputNumber) {
        ...
        ObNummerFieldValidator.prototype.insertStringPartAtPosition = function (targetString, index, stringPart) {
            return targetString.substr(0, index) + stringPart + targetString.substr(index);
        };
        ;
        return ObNummerFieldValidator;
