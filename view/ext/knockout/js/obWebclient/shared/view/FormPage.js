...
define(["require", "exports", "jquery", "knockout"], function (require, exports, $, ko) {
    ...
    var FormPage = /** @class */ (function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, formModel.isModelReady().then(function () {
        ...
        FormPage.prototype.applyModel = function () {
            this.applyMenuPart();
            this.applyFormPart();
        };
        return FormPage;
